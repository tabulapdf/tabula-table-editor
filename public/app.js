...
var TableView = Backbone.View.extend({
    ...
    _createSelectTool: function() {
        ...
        var extendSelection = _.bind(function(targetRectangle) {
            ...
            // if (this.selectedRectangles.bounds.contains(targetRectangle)) {
            //     this.selectedRectangles.removeChildren();
            // }
            // else {
            //     console.log('outside');
        ...
        var drawSelection = _.bind(function() {
            ...
            _.each(['center', 'topRight', 'topLeft', 'bottomLeft', 'bottomRight'],
                   _.bind(
                       function(d) {
                           if (!(this.selectedRectangles.bounds[d] in this.intersectionPoints)) {
                               selection = selection.unite(this._findDefinedRectangle(this.selectedRectangles.bounds[d]));
                           }
                       }, this)
                  );

            console.log(this.intersectionPoints[this.selectedRectangles.bounds.center]);
